...
export const SearchInput = () => {
    return (
        <div className="relative">
            ...
            <input type="text" placeholder="Search" className="bg-black/5 border-none outline-none rounded-[8px] placeholder:text-neutral-400 focus:outline-none focus:ring-0 active:outline-none focus:border-none active:ring-0 pr-2 pl-7 py-1" />
