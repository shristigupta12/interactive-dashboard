...
export const SearchInput = ({
    ...
    return (
        <div className="relative">
            ...
            <input type="text" placeholder="Search" className={`${backgroundColor} ${borderColor} outline-none rounded-[8px] ${theme === 'dark' ? 'text-white' : 'text-black'} placeholder:text-neutral-400 focus:outline-none focus:ring-0 active:outline-none active:ring-0 pr-2 pl-7 py-1 text-sm`} value={value} onChange={(e) => onChange(e.target.value)} />
            {showIcon && (
                <>
